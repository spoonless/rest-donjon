...
public class DonjonService {
	...
	private void creerDonjon() {
		...
		Salle salle22 = salle("Vous entrez dans une salle avec au centre un puits");
		Salle salle221 = salle("Vous glissez lors de la descente du puits et vous vous écrasez au fond. Votre aventure s'achève ici !");
		...
		salle22.addPorte("le puits", salle221);
